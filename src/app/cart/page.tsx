    ...
    <main className={"px-4 lg:px-56  mt-20 mb-60 "}>
      ...
      <section className={"mt-12 max-w-[850px] mx-auto"}>
        ...
        <ul className={"flex flex-col gap-[1.6rem]"}>
          {items.map((product: ItemCart, key: number) => {
            ...
            return (
              <li key={key}
                  ...
                  <div className={'flex flex-col gap-4'}>
                    ...
                    <div className={'flex lg:hidden items-center gap-[.8rem]'}>
                      <div
                        ...
                        <button onClick={() => setItems((prev: ItemCart[]) => {
                          prev.map((p: ItemCart) => {
                            if (p.id === product.id) {
                      ...
                      <Image onClick={() => setItems((prev: ItemCart[]) => {
                        return prev.filter((p: ItemCart) => p.id != product.id)
                ...
                <div className={'hidden lg:flex items-center gap-[1.6rem]'}>
                  ...
                  <Image className={'cursor-pointer'} onClick={() => setItems((prev: ItemCart[]) => {
                    return prev.filter((p: ItemCart) => p.id != product.id)
